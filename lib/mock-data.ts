...
export const mockRecommendations: Recommendation[] = [
  ...
  },
  {
    ...
    whyRecommended: [
      ...
      "Well-established project with 28,400 stars.",
    ],
  ...
  },
  {
    ...
    whyRecommended: [
      ...
      "Marked as a good first issue — ideal for new contributors.",
      "Well-established project with 86,200 stars.",
    ],
    difficulty: "beginner",
  ...
  },
  {
    ...
    whyRecommended: [
      "Project focuses on systems programming.",
      "Open for community contributions.",
      "Well-established project with 38,100 stars.",
    ],
    difficulty: "advanced",
    matchedLabels: [],
    readme: {
  ...
  },
  {
    ...
    whyRecommended: [
      "Uses Rust, which matches your selected language.",
      "Marked as a good first issue — ideal for new contributors.",
      "Well-established project with 100,300 stars.",
    ],
    difficulty: "beginner",
